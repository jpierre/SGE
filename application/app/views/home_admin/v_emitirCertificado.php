		...
		<tbody>
			...
			<tr class="statement284">
				...
				<td><a href="<?php base_url()?>/sge/index.php/administracion/c_administracion/generarCertificado/<?=$participantes[$i]->cod_user?>/<?=$evento->id_eve?>"><img  alt="Generar Certificado"
					...
					href="<?php echo base_url();?>/index.php/administracion/c_administracion/consultarAsistenciaXApePat/<?=$participantes[$i]->ape_pat_user?>"><img alt="Ver Asistencia"
