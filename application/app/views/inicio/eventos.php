	...
	<body lang="en">
		...
		<div id="mobile-nav-holder">
			<div class="wrapper">
				<ul id="mobile-nav">
					...
					<li  class="current-menu-item"><a href="<?php echo base_url(); ?>seccion/eventos">Eventos</a>
						<ul>
			...
			<div class="wrapper">
				...
				<nav>
					<ul id="nav" class="sf-menu">
						...
						<li class="current-menu-item"><a href="<?php echo base_url(); ?>seccion/eventos">Eventos<span class="subheader">Eventos</span></a>
							<ul>
								<li><a href="page-full.php">SOCOTEC 2013</a></li>
								<li><a href="page-features.php">1ros Juegos Florales</a></li>
		...
		<div id="main">
			...
			<div id="content">
				...
				<!-- masthead -->
		        <div id="masthead">
					<span class="head">Proximos Eventos</span><span class="subhead">Inscribete ya !</span>
	        	...
	        	<div id="posts-list">
					...
					<article class="format-standard">
						...
						<div class="feature-image">
							<a href="<?php echo base_url(); ?>images/img/eventos/socote2013.jpg" data-rel="prettyPhoto"><img src="<?php echo base_url(); ?>images/img/eventos/socote2013.jpg" alt="Alt text" /></a>
						</div>
						
						<h1><a href="single.php" class="post-heading">V Congreso Iberiamericano - Soporte del Conocimiento de la Tecnologia.</a></h1>
						<div class="meta">
						...
						<div class="excerpt">Este año la sede del Congreso sera la Universidad de San Martin de Porres en Lima-Peru, institucion que organiza este evento en cooperacion con la Universidad Politecnica de Valencia (España), y el apoyo de las universidades españolas: Universidad Politecnica de Madrid, Universidad Politecnica de Cataluña, Universidad de Cantabria y  Universidad de Murcia, con el objetivo de difundir y promover la investigacion cientifica, la innovacion tecnologica, las experiencias empresariales y las ultimas teorias y practicas sobre las Tecnologias de la Informacion y la Comunicacion (TIC).
						</div>
						
						<a href="single.php" class="read-more">Leer mas</a>
					...
					<article class="format-standard">
						...
						<div class="feature-image">
							<a href="<?php echo base_url(); ?>images/img/eventos/juegos_florales2013.jpg" data-rel="prettyPhoto"><img src="<?php echo base_url(); ?>images/img/eventos/juegos_florales2013.jpg" alt="Alt text" /></a>
						</div>
						
						<h1><a href="single.php" class="post-heading">Juegos Florales 2013</a></h1>
						<div class="meta">
							<span class="entry-day">23</span>
							<span class="entry-year">sep 2011</span>
						</div>
						...
						<div class="excerpt">Participa en los I Juegos Florales FIA 2013 que se desarrollan en el marco del Trigésimo Aniversario de la Facultad.
						</div>
					...
					<article class="format-standard">
						...
						<div class="feature-image">
							<a href="<?php echo base_url(); ?>images/img/slides/03.jpg" data-rel="prettyPhoto"><img src="<?php echo base_url(); ?>images/img/slides/03.jpg" alt="Alt text" /></a>
						</div>
						
						<h1><a href="single.php" class="post-heading">Lorem ipsum dolor amet</a></h1>
						<div class="meta">
							<span class="entry-day">23</span>
							<span class="entry-year">sep 2011</span>
						</div>
