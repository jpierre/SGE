...
<header>
  <div class="wrapper"> <a href="<?php echo base_url(); ?>seccion/inicio" id="logo"><img  src="<?php echo base_url(); ?>images/img/logo.png" alt="Tandem"></a>
    <nav>
...
<div id="main"> 
  ...
  <div id="content"> 
    ...
    <!-- masthead -->
    <div id="masthead"> <span class="head">Registrate</span>
      ...
      <form action="<?php echo base_url();?>inscripcion/c_registro/create_member" method="post" accept-charset="utf-8" class="box" >
        <div id="personal">
          <fieldset>
            ...
            <input type="text" name="ape_pat" required value="<?php echo set_value('ape_pat'); ?>"/>
            <br>
            <br>
            <a style="text-decoration: none; font-size: 8pt; color:red"><?php echo form_error('ape_pat'); ?></a>
            <label>Apellido Materno*</label>
            <input type="text" name="ape_mat" required value="<?php echo set_value('ape_mat'); ?>"/>
            <br>
            <br>
            ...
            <label>Celular*</label>
            <input type="text" name="celular" required value="<?php echo set_value('celular'); ?>"/>
            <br>
            <br>
            <a style="text-decoration: none; font-size: 8pt; color:red"><?php echo form_error('celular'); ?></a>
            <label>Correo*</label>
            <input type="text" name="email_adress" required value="<?php echo set_value('email_adress'); ?>"/>
            <br>
            <br>
            <a style="text-decoration: none; font-size: 8pt; color:red"><?php echo form_error('email_adress'); ?></a>
            <label>Direccion</label>
            <input type="text" name="direccion" required value="<?php echo set_value('direccion'); ?>"/>
            <br>
            <br>
    ...
    <ul id="footer-cols">
      <li class="first-col">
        <div class="widget-block">
          <h4>Recent posts</h4>
          <div class="recent-post"> <a href="#" class="thumb"><img src="<?php echo base_url(); ?>images/img/dummies/54x54.gif" alt="Post" /></a>
