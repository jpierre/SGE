				...
				<!-- form -->
					...
					<form id="contactForm" action="#" method="post">
						...
						<tr>
								...
								<td><input name="email"  id="email" type="text" class="form-poshytip" title="Ingresa tu usuario" /></td>
						</tr>
						<tr>					
								<td><label>Password</label></td>
								<td><input name="email"  id="email" type="text" class="form-poshytip" title="Ingresa tu password" /></td>
						<tr>
						</table>
							<p><input type="button" value="Entrar" name="submit" id="submit" /></p>
