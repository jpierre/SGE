...

                        {
                            ...
                            handler: function(button, event) {
                                ...
                                if(id_eve!='-1'){
									...
									Ext.getCmp('fech_ini_eve').setValue(Ext.Date.format(new Date(record.get('fech_ini_eve')), 'd-m-Y'));
                                    Ext.getCmp('fech_fin_eve').setValue(Ext.Date.format(new Date(record.get('fech_fin_eve')), 'd-m-Y'));
                                    ...
                                    winp.show();
									winp.setTitle('Modificar Evento');
