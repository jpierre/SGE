                        ...
                        },
                        {
                            ...
                            handler: function(button, event) {
                                ...
                                if(id_pon!='-1'){
                                    ...
                                    Ext.getCmp('fech_ini_pon').setValue(Ext.Date.format(new Date(record.get('fech_ini_pon')), 'd-m-Y H:i:s'));
                                    Ext.getCmp('fech_fin_pon').setValue(Ext.Date.format(new Date(record.get('fech_fin_pon')), 'd-m-Y H:i:s'));
